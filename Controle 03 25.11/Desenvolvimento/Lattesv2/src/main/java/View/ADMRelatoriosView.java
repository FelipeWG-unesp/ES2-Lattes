...
public class ADMRelatoriosView extends JFrame {

    public ADMRelatoriosView() {
        setTitle("Relatórios do Administrador");
        setSize(400, 200);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ADMRelatoriosView().setVisible(true));
    }
}
